...
module.exports = {
  ...
  sudo: process.env.SUDO || '260776642930',
  alivepic: process.env.ALIVE_IMG || 'https://telegra.ph/file/ad25b2227fa2a1a01b707.jpg',
  alivemsj: process.env.ALIVE_MSJ || '*POWERD BY NIPSY* 🎊',
  ownername:process.env.OWNER_NAME || 'Nipsy-Hus-Tle',
  sessionName: process.env.SESSION_ID || 'PUT-HERE',
  author: process.env.PACK_INFO.split(";")[0] || 'created by', 
  auto_read_status : process.env.AUTO_READ_STATUS || 'true',
  packname: process.env.PACK_INFO.split(";")[1] || 'Nipsy💋',
  ...
  HEROKU_APP_NAME: process.env.HEROKU_APP_NAME || 'nipsy',
